...
import { Alert, StyleSheet, Text, TextInput, TouchableOpacity, View } from "react-native"; // Added Image, TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  logo: {
    ...
    marginBottom: 10,
    resizeMode: 'contain',
    // You'll need to provide your actual logo image path
  },
  headerText: {
    color: "white",
    fontSize: 24,
