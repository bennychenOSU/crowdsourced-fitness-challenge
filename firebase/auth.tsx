...
export const createDummyUser = async (email: string, password: string, displayName?: string) => {
  try {
...
export const loginDummyUser = async () => {
  ...
  try {
    ...
    if (error.code === 'auth/invalid-credential' || error.code === 'auth/user-not-found') {
      console.log('Dummy user not found or invalid credentials, attempting to create...');
      try {
        const newUser = await createDummyUser(DUMMY_EMAIL, DUMMY_PASSWORD, DUMMY_DISPLAY_NAME);
